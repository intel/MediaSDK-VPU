...
#define XL_CREATE_PARTITION			_IOW(XLINK_MAGIC, 101, void*)
#define XL_FLASH_PARTITION			_IOW(XLINK_MAGIC, 102, void*)
#define XL_RECOVERY_DONE			_IOW(XLINK_MAGIC, 103, void*)
#define XL_ERASE_PARTITION			_IOW(XLINK_MAGIC, 104, void*)
...
struct xlinkpartition {
	void* handle;
	__u32* return_code;
};

struct xlinkflashpartition {
	void* handle;
	__u32 partition_name;
	const char* binary_name;
	__u32 binary_name_size;
	__u32* return_code;
};
